...
export default function BlogManagementTable({ 
  ...
  const loadBlogs = useCallback(async (showLoading = true) => {
    try {
      ...
      const filters: BlogTableFilters = {
  ...
  }, [searchTerm, statusFilter, currentPage, itemsPerPage, sortField, sortOrder, featuredFilter]);
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Select 
              value={featuredFilter === undefined ? 'all' : featuredFilter.toString()} 
              onValueChange={(value) => setFeaturedFilter(value === 'all' ? undefined : value === 'true')}
            >
              <SelectTrigger className="w-32">
