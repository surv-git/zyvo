...
const addressSchema = z.object({
  alias: z.string().min(1, 'Address name is required'),
...
const paymentSchema = z.object({
  alias: z.string().min(1, 'Payment method name is required'),
  paymentType: z.enum(['CREDIT_CARD', 'DEBIT_CARD', 'UPI', 'NETBANKING', 'WALLET']),
...
const FormBasedCheckout = () => {
  ...
  const [addressData, setAddressData] = React.useState<AddressFormValues | null>(null)
  const [paymentData, setPaymentData] = React.useState<PaymentFormValues | null>(null)
  ...
  return (
    <AuthGuard>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-3xl font-bold mb-8">Checkout with Forms</h1>
