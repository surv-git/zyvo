      ...
      <section className="py-20 bg-gradient-to-br from-green-50 via-white to-teal-50">
        <div className="max-w-full mx-auto lg:px-36 px-4">
          <SectionHeader
            ...
            subtitle="Discover our newest arrivals and cutting-edge innovations"
          />
        ...
        <div className="max-w-full mx-auto text-center lg:px-36 px-4">
          ...
          <div className="bg-white rounded-2xl p-12 shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-neutral-900 mb-4">
              {error ? 'Something went wrong' : 'No Latest Products Yet'}
            </h3>
            <p className="text-neutral-600 mb-6">
              {error || 'Check back soon for our newest arrivals!'}
            </p>
            {error && (
    ...
    <section className="py-20 bg-gradient-to-br from-green-50 via-white to-teal-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%2310b981' fill-opacity='0.03'%3E%3Cpath d='M40 40c0-8.837 7.163-16 16-16s16 7.163 16 16-7.163 16-16 16-16-7.163-16-16zm-16 0c0-8.837 7.163-16 16-16s16 7.163 16 16-7.163 16-16 16s16-7.163-16-16z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
        }}></div>
      </div>
      ...
      <div className="max-w-full mx-auto relative lg:px-36 px-4">
        ...
        <div className="text-center mt-16">
          <div className="bg-white bg-opacity-90 rounded-3xl p-8 shadow-lg border-2 border-green-100" style={{ backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)' }}>
            <div className="flex items-center justify-center mb-4">
              <Calendar className="w-8 h-8 text-green-500 mr-3" />
              <h3 className="text-2xl font-bold text-neutral-900">
                Explore More Latest Products
              </h3>
            </div>
            <p className="text-neutral-600 mb-6">
              Stay ahead of the curve with our newest product releases.
            </p>
            <Button
              size="lg"
              className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-3 shadow-lg transition-all duration-200 border-0"
              asChild
            >
