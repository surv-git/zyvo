    ...
    <section className="py-20 bg-gradient-to-br from-secondary-50 via-white to-orange-50 relative overflow-hidden">
      ...
      <div className="max-w-full mx-auto relative lg:px-36 px-4">
        ...
        <div className="text-center mt-16">
          <div className="bg-white bg-opacity-90 rounded-3xl p-8 shadow-lg border-2 border-emerald-100" style={{ backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)' }}>
            <div className="flex items-center justify-center mb-4">
              <Crown className="w-8 h-8 text-emerald-500 mr-3" />
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-8 py-3 shadow-lg transition-all duration-200 border-0"
              asChild
            >
